    ...
    >
      ...
      <template v-else-if="!error && analysisData">
        ...
        <view class="learning-plan-section">
          ...
          <!-- 基于 gap_analysis 和 skill-knowledge.json 的学习计划 -->
...
import { getCareerPlanningAnalysis, getCareerPlanningInterviewPrepStream, type CareerPlanningAnalysisResponse } from '@/services/api/recommendations';
