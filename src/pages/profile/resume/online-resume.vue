...
function handleEditBasicInfo() {
  uni.navigateTo({
    url: '/pages/profile/resume/edit/basic-info',
  });
}
...
function handleAddExpectation() {
  uni.navigateTo({
    url: '/pages/profile/resume/edit/expectation',
  });
}

function handleEditExpectation(expectation: JobSeekerExpectation) {
  uni.navigateTo({
    url: `/pages/profile/resume/edit/expectation?id=${expectation.id}`,
  });
}

function handleAddWork() {
  uni.navigateTo({
    url: '/pages/profile/resume/edit/work-experience',
  });
}

function handleEditWork(work: WorkExperience) {
  uni.navigateTo({
    url: `/pages/profile/resume/edit/work-experience?id=${work.id}`,
  });
}

function handleAddProject() {
  uni.navigateTo({
    url: '/pages/profile/resume/edit/project-experience',
  });
}
...
function handleEditProject(project: ProjectExperience) {
  if (project.id) {
    uni.navigateTo({
      url: `/pages/profile/resume/edit/project-experience?id=${project.id}`,
    });
  }
}
...
function handleAddEducation() {
  uni.navigateTo({
    url: '/pages/profile/resume/edit/education-experience',
  });
}

function handleEditEducation(education: EducationExperience) {
  uni.navigateTo({
    url: `/pages/profile/resume/edit/education-experience?id=${education.id}`,
  });
}

function handleAddSkill() {
  uni.navigateTo({
    url: '/pages/profile/resume/edit/skill',
  });
}

function handleEditSkill(skill: Skill) {
  uni.navigateTo({
    url: `/pages/profile/resume/edit/skill?id=${skill.id}`,
  });
}
