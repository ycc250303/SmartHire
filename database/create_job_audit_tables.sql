...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='职位审核记录表';

-- 扩展职位表，添加审核相关字段
ALTER TABLE `job_info`
ADD COLUMN `audit_status` VARCHAR(20) DEFAULT 'draft' COMMENT '审核状态: draft-草稿 pending-待审核 approved-已通过 rejected-已拒绝 modified-需修改',
