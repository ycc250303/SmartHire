...
CREATE TABLE `job_seeker` (
    ...
    `education` TINYINT COMMENT '最高学历 0-高中及以下 1-专科 2-全日制本科 3-非全日制本科 4-全日制硕士 5-非全日制硕士 6-全日制博士 7-非全日制博士',
...
CREATE TABLE `education_experience` (
    ...
    `education` TINYINT COMMENT '学历 0-高中及以下 1-全日制本科 2-非全日制本科 3-全日制硕士 4-非全日制硕士 5-全日制博士 6-非全日制博士',
...
CREATE TABLE `job_position` (
    ...
    `education_required` TINYINT COMMENT '学历要求 0-高中及以下 1-专科 2-本科 3-硕士 4-博士 5-不限',
