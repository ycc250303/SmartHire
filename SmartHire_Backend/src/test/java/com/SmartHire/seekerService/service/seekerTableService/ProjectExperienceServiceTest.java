 ...
 *
 * <p>测试目标：防止项目经历添加、更新、删除等核心业务逻辑回归
 *
...
class ProjectExperienceServiceTest {
  ...
  @Mock private ProjectExperienceMapper projectExperienceMapper;

  @Mock private JobSeekerService jobSeekerService;

  @Spy @InjectMocks private ProjectExperienceServiceImpl projectExperienceService;
  ...
  private void mockLambdaQueryCount(long count) {
    LambdaQueryChainWrapper<ProjectExperience> queryWrapper =
        new LambdaQueryChainWrapper<>(projectExperienceMapper, ProjectExperience.class);
