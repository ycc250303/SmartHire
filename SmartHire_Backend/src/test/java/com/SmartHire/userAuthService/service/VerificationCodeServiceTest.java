 ...
 * 测试原则：
 * <ul>
 * <li>使用 Mockito mock 外部依赖（邮件服务、Redis）</li>
 * <li>保留真实业务逻辑测试（验证码生成、发送逻辑）</li>
 * <li>使用 Arrange / Act / Assert 三段式结构</li>
 * <li>严格遵循测试用例矩阵，不添加额外测试</li>
 * </ul>
 *
 * <p>
 * 测试范围说明：
 * <ul>
 * <li>✅ TC-VERIFY-001: 成功发送验证码（本测试文件）</li>
 * </ul>
 *
 * <p>
 * 注意：本测试基于 API 文档和测试用例矩阵推导，严格遵循矩阵定义的 10 个测试用例
 *
