package com.SmartHire.seekerService;
...
/**
 * SeekerService 启动类 使用 application-seeker-service.yml 配置文件
 *
 * @author SmartHire Team
 */
@SpringBootApplication(scanBasePackages = "com.SmartHire")
@MapperScan("com.SmartHire.seekerService.mapper")
public class SeekerApplication {

  public static void main(String[] args) {
    // 创建 SpringApplication 实例
    SpringApplication app = new SpringApplication(SeekerApplication.class);

    // 注意：profile 名称是文件名中 application- 和 .yml 之间的部分
    app.setAdditionalProfiles("seeker-service");
