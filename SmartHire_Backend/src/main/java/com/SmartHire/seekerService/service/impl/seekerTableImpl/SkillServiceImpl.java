...
@Slf4j
@Service
public class SkillServiceImpl extends AbstractSeekerOwnedService<SkillMapper, Skill> implements SkillService {
    ...
    private Skill getOwnedSkill(Long id, Long jobSeekerId) {
        return requireOwnedEntity(id, skillMapper::selectById, Skill::getJobSeekerId,
                ErrorCode.SKILL_NOT_EXIST, ErrorCode.SKILL_NOT_BELONG_TO_USER);
    }
