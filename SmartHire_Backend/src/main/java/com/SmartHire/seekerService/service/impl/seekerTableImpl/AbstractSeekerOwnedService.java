 ...
 * @param <T> 实体类型
 */
public abstract class AbstractSeekerOwnedService<M extends BaseMapper<T>, T>
    extends ServiceImpl<M, T> {

  @Autowired protected JobSeekerService jobSeekerService;
   ...
   */
  protected T requireOwnedEntity(
      Long id,
