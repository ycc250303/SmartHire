package com.SmartHire.recruitmentService;
...
/**
 * RecruitmentService 启动类 使用 application-recruitment-service.yml 配置文件
 *
 * @author SmartHire Team
 */
@SpringBootApplication(scanBasePackages = "com.SmartHire")
@MapperScan("com.SmartHire.recruitmentService.mapper")
public class RecruitmentApplication {

  public static void main(String[] args) {
    // 创建 SpringApplication 实例
    SpringApplication app = new SpringApplication(RecruitmentApplication.class);

    // 注意：profile 名称是文件名中 application- 和 .yml 之间的部分
    app.setAdditionalProfiles("recruitment-service");
