package com.SmartHire.messageService;
...
/**
 * MessageService 启动类 使用 application-message-service.yml 配置文件
 *
 * @author SmartHire Team
 */
@SpringBootApplication(scanBasePackages = "com.SmartHire")
@MapperScan("com.SmartHire.messageService.mapper")
public class MessageApplication {
  ...
  public static void main(String[] args) {
    ...
    app.setAdditionalProfiles("message-service");
