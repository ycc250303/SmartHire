package com.SmartHire.adminService;
...
/**
 * AdminService 启动类 使用 application-admin-service.yml 配置文件
 *
 * @author SmartHire Team
 */
@SpringBootApplication(scanBasePackages = "com.SmartHire")
@MapperScan("com.SmartHire.adminService.mapper")
public class AdminApplication {
  ...
  public static void main(String[] args) {
    ...
    app.setAdditionalProfiles("admin-service");
