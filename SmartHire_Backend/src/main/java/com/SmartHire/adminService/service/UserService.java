...
public interface UserService extends IService<User> {
     ...
     * @return 用户管理DTO列表
     */
    Page<UserManagementDTO> getUserManagementList(Page<UserManagementDTO> page, String userType, String status, String keyword);
     ...
     * @return 成功数量
     */
    int batchUpdateUserStatus(List<Long> userIds, Byte status, Long operatorId, String operatorName, String reason);
