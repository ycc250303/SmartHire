...
public class AliOssUtil {
    ...
    public String uploadFile(String objectName, InputStream in) throws IOException {
        ...
        try {
            ...
            log.error("OSSException during upload. objectName={}, code={}, message={}, requestId={}",
                    objectName, oe.getErrorCode(), oe.getErrorMessage(), oe.getRequestId(), oe);
            throw new RuntimeException("OSS上传失败，请检查凭证配置", oe);
        } catch (ClientException ce) {
            log.error("ClientException during upload. objectName={}, message={}", objectName, ce.getMessage(), ce);
     ...
     * @param in           文件输入流
     */
    public String uploadFile(String directoryKey, String fileName, InputStream in) throws IOException {
    ...
    public boolean deleteFile(String objectName) {
        ...
        try {
            ...
            log.warn("删除OSS文件失败，objectName={}, code={}, message={}, requestId={}",
                    objectName, oe.getErrorCode(), oe.getErrorMessage(), oe.getRequestId(), oe);
        } catch (ClientException ce) {
