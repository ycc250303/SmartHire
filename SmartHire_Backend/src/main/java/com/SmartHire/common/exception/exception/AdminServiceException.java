...
public class AdminServiceException extends BaseException {
  ...
  public AdminServiceException(
      com.SmartHire.common.exception.enums.ErrorCode errorCode, String message) {
  ...
  public static AdminServiceException userNotFound(Long userId) {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_USER_NOT_FOUND, "用户不存在: " + userId);
  }

  /** 用户已封禁异常 */
  public static AdminServiceException userAlreadyBanned(Long userId) {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_USER_ALREADY_BANNED,
        "用户已被封禁: " + userId);
  }
  ...
  public static AdminServiceException userNotBanned(Long userId) {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_USER_NOT_BANNED,
        "用户当前未被封禁: " + userId);
  }
  ...
  public static AdminServiceException cannotBanAdmin() {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_CANNOT_BAN_ADMIN, "不能封禁管理员账户");
  }

  /** 不能修改管理员状态异常 */
  public static AdminServiceException cannotModifyAdminStatus() {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_CANNOT_MODIFY_ADMIN_STATUS,
        "不能修改管理员账户状态");
  }
  ...
  public static AdminServiceException invalidBanType(String banType) {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_INVALID_BAN_TYPE,
        "无效的封禁类型: " + banType);
  }
  ...
  public static AdminServiceException banDaysMustBePositive() {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_BAN_DAYS_MUST_BE_POSITIVE,
        "封禁天数必须大于0");
  }
  ...
  public static AdminServiceException operationFailed(String operation) {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_OPERATION_FAILED, operation + "失败");
  }

  /** 职位不存在异常 */
  public static AdminServiceException jobNotFound(Long jobId) {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.JOB_NOT_EXIST, "职位不存在，ID: " + jobId);
  }

  /** 职位状态异常 */
  public static AdminServiceException invalidJobStatus(String status) {
    return new AdminServiceException(
        com.SmartHire.common.exception.enums.ErrorCode.ADMIN_OPERATION_FAILED,
        "无效的职位状态: " + status);
  }
}
